...
%DIF ADD submission_02.tex   Wed May  5 18:02:22 2021
...
\usepackage{siunitx}
%DIF 8a8-10
\usepackage{xr-hyper} % to cross-ref from review response %DIF > 
...
\cref{fig:historic_era5,fig:historic_bk,fig:historic_tx}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .
...
\DIFdelbegin \DIFdel{Reproducibility is facilitated through the Snakemake library \mbox{%DIFAUXCMD
