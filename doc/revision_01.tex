...
%DIF ADD submission_02.tex   Mon May  3 16:43:48 2021
...
\begin{abstract}
  ...
  We compute the \DIFdelbegin \DIFdel{population weighted temperature excursion below \mbox{%DIFAUXCMD
...
Currently \DIFdelbegin \DIFdel{over }\DIFdelend \DIFaddbegin \DIFadd{at }\DIFaddend 50\% of Texas households use electricity for space heating over the majority of census tracts of the state \cite{waite_heating:2020} and further electrification is a central element of many plans to decarbonize our energy sector \cite{williams_decarbonization:2012,davis:2018,white_txresidential:2019}.
